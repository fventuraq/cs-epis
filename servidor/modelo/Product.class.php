...
class Product extends ModeloGenerico{

	function Product(){

		parent::__construct("WS_PRODUCT");
	...
	public function lastProduct($orgID,$webSitID){
		//consulta
		//$sql = "SELECT MAX(ConID) as ConID FROM " . $this->nombreTabla ." WHERE OrgID=:1 AND WebSitID=:2";
		$sql = "SELECT MAX(ProID) as ProID FROM " . $this->nombreTabla ." ";
