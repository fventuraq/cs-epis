	...
	public function processPOST($datos){
		...
		if( $res['estado'] ){
            ...
            if($res['estado']){
                ...
                $json = "{";
                $json .= "\"jwt\":" . json_encode( JWT::encode(MiJWT::generarToken2($idsession,$usu['OrgID'],$usu['RolID'],$usu['UseID'],$tiempoInicio,JWT::$tiempoMaxEx), MiJWT::$miClave, MiJWT::$miAlgoritmo) );
                $json .= ',';
